	...
	*/
	for (test_case = 1; test_case <= T; ++test_case)
	{
		...
		*/
		...
		int targetStrSize = strLen(targetStr);
		int result = 0;
		int matchedCnt = 0;
		
		for (int i = 0; i <= inputStrSize - targetStrSize ; i++){
			for (int j = 0; j < targetStrSize ; j++){
